...
HASH_TABLE_INDEX_TYPE::LinearProbeHashTableIndex(
...
template class LinearProbeHashTableIndex<GenericKey<4>, RID,
                                         GenericComparator<4>>;
template class LinearProbeHashTableIndex<GenericKey<8>, RID,
                                         GenericComparator<8>>;
template class LinearProbeHashTableIndex<GenericKey<16>, RID,
                                         GenericComparator<16>>;
template class LinearProbeHashTableIndex<GenericKey<32>, RID,
                                         GenericComparator<32>>;
template class LinearProbeHashTableIndex<GenericKey<64>, RID,
