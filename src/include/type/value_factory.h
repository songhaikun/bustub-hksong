...
public:
  ...
  static inline auto GetTinyIntValue(int8_t value) -> Value {
    return {TypeId::TINYINT, value};
  }

  static inline auto GetSmallIntValue(int16_t value) -> Value {
  ...
  static inline auto GetBigIntValue(int64_t value) -> Value {
    return {TypeId::BIGINT, value};
  }

  static inline auto GetTimestampValue(int64_t value) -> Value {
    return {TypeId::TIMESTAMP, value};
  }

  static inline auto GetDecimalValue(double value) -> Value {
    return {TypeId::DECIMAL, value};
  }

  static inline auto GetBooleanValue(CmpBool value) -> Value {
    return {TypeId::BOOLEAN, value == CmpBool::CmpNull
                                 ? BUSTUB_BOOLEAN_NULL
  ...
  static inline auto GetBooleanValue(int8_t value) -> Value {
  ...
  static inline auto GetVarcharValue(const char *value, uint32_t len,
                                     bool manage_data,
                                     __attribute__((__unused__))
                                     AbstractPool *pool = nullptr) -> Value {
  ...
  static inline auto GetZeroValueByType(TypeId type_id) -> Value {
    ...
    throw Exception(ExceptionType::UNKNOWN_TYPE,
                    "Unknown type for GetZeroValueType");
  }

  static inline auto CastAsBigInt(const Value &value) -> Value {
    if (Type::GetInstance(TypeId::BIGINT)->IsCoercableFrom(value.GetTypeId())) {
      if (value.IsNull()) {
        return ValueFactory::GetBigIntValue(
            static_cast<int64_t>(BUSTUB_INT64_NULL));
      }
      switch (value.GetTypeId()) {
      case TypeId::TINYINT:
        return ValueFactory::GetBigIntValue(
            static_cast<int64_t>(value.GetAs<int8_t>()));
      case TypeId::SMALLINT:
        return ValueFactory::GetBigIntValue(
            static_cast<int64_t>(value.GetAs<int16_t>()));
      case TypeId::INTEGER:
        return ValueFactory::GetBigIntValue(
            static_cast<int64_t>(value.GetAs<int32_t>()));
      case TypeId::BIGINT:
      ...
      case TypeId::DECIMAL: {
        ...
        return ValueFactory::GetBigIntValue(
            static_cast<int64_t>(value.GetAs<double>()));
      }
      case TypeId::VARCHAR: {
    ...
    throw Exception(Type::GetInstance(value.GetTypeId())->ToString(value) +
  ...
  static inline auto CastAsInteger(const Value &value) -> Value {
    if (Type::GetInstance(TypeId::INTEGER)
      ...
      switch (value.GetTypeId()) {
      case TypeId::TINYINT:
        return ValueFactory::GetIntegerValue(
            static_cast<int32_t>(value.GetAs<int8_t>()));
      case TypeId::SMALLINT:
        return ValueFactory::GetIntegerValue(
            static_cast<int32_t>(value.GetAs<int16_t>()));
      case TypeId::INTEGER:
      ...
      case TypeId::BIGINT: {
        ...
        return ValueFactory::GetIntegerValue(
            static_cast<int32_t>(value.GetAs<int64_t>()));
      }
      case TypeId::DECIMAL: {
        ...
        return ValueFactory::GetIntegerValue(
            static_cast<int32_t>(value.GetAs<double>()));
      }
      case TypeId::VARCHAR: {
        std::string str = value.ToString();
        int32_t integer = 0;
    ...
    if (Type::GetInstance(TypeId::SMALLINT)
      ...
      if (value.IsNull()) {
        return ValueFactory::GetSmallIntValue(
            static_cast<int16_t>(BUSTUB_INT16_NULL));
      }
      switch (value.GetTypeId()) {
      case TypeId::TINYINT:
        return ValueFactory::GetSmallIntValue(
            static_cast<int16_t>(value.GetAs<int8_t>()));
      case TypeId::SMALLINT:
      ...
      case TypeId::INTEGER: {
        ...
        return ValueFactory::GetSmallIntValue(
            static_cast<int16_t>(value.GetAs<int32_t>()));
      }
      case TypeId::BIGINT: {
        ...
        return ValueFactory::GetSmallIntValue(
            static_cast<int16_t>(value.GetAs<int64_t>()));
      }
      case TypeId::DECIMAL: {
        ...
        return ValueFactory::GetSmallIntValue(
            static_cast<int16_t>(value.GetAs<double>()));
      }
      case TypeId::VARCHAR: {
        std::string str = value.ToString();
        int16_t smallint = 0;
  ...
  static inline auto CastAsTinyInt(const Value &value) -> Value {
    if (Type::GetInstance(TypeId::TINYINT)
      ...
      case TypeId::SMALLINT: {
        ...
        return ValueFactory::GetTinyIntValue(
            static_cast<int8_t>(value.GetAs<int16_t>()));
      }
      case TypeId::INTEGER: {
        ...
        return ValueFactory::GetTinyIntValue(
            static_cast<int8_t>(value.GetAs<int32_t>()));
      }
      case TypeId::BIGINT: {
        ...
        return ValueFactory::GetTinyIntValue(
            static_cast<int8_t>(value.GetAs<int64_t>()));
      }
      case TypeId::DECIMAL: {
        ...
        return ValueFactory::GetTinyIntValue(
            static_cast<int8_t>(value.GetAs<double>()));
      }
      case TypeId::VARCHAR: {
        std::string str = value.ToString();
        int8_t tinyint = 0;
    ...
    if (Type::GetInstance(TypeId::DECIMAL)
      ...
      if (value.IsNull()) {
        return ValueFactory::GetDecimalValue(
            static_cast<double>(BUSTUB_DECIMAL_NULL));
      }
      switch (value.GetTypeId()) {
      case TypeId::TINYINT:
        return ValueFactory::GetDecimalValue(
            static_cast<double>(value.GetAs<int8_t>()));
      case TypeId::SMALLINT:
        return ValueFactory::GetDecimalValue(
            static_cast<double>(value.GetAs<int16_t>()));
      case TypeId::INTEGER:
        return ValueFactory::GetDecimalValue(
            static_cast<double>(value.GetAs<int32_t>()));
      case TypeId::BIGINT:
        return ValueFactory::GetDecimalValue(
            static_cast<double>(value.GetAs<int64_t>()));
      case TypeId::DECIMAL:
