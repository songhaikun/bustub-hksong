...
private:
  ...
  auto UpgradeLockTable(Transaction *txn, LockMode lock_mode,
                        const table_oid_t &oid) -> bool;
  auto UpgradeLockRow(Transaction *txn, LockMode lock_mode,
  ...
  auto CanLockUpgrade(LockMode curr_lock_mode, LockMode requested_lock_mode)
      -> bool;
  auto CheckAppropriateLockOnTable(Transaction *txn, const table_oid_t &oid,
...
template <>
struct fmt::formatter<bustub::LockManager::LockMode>
